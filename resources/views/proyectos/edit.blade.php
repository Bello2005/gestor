                                ...
                                <div class="mt-3 p-3 bg-matter-light rounded-lg overflow-hidden">
                                    <div class="flex items-center justify-between gap-2">
                                        <div class="flex items-center gap-2 min-w-0 flex-1">
                                            ...
                                            <a href="{{ $proyecto->archivo_proyecto_url }}" target="_blank" class="text-quantum-400 hover:text-quantum-300 text-sm truncate">
                                ...
                                <div class="mt-3 p-3 bg-matter-light rounded-lg overflow-hidden">
                                    <div class="flex items-center justify-between gap-2">
                                        <div class="flex items-center gap-2 min-w-0 flex-1">
                                            ...
                                            <a href="{{ $proyecto->contrato_convenio_url }}" target="_blank" class="text-void-400 hover:text-void-300 text-sm truncate">
                                            ...
                                            <div class="min-w-0 flex-1 overflow-hidden">
                                                @php
                                                    $evidenciaUrl = (strpos($evidencia, 'http://') === 0 || strpos($evidencia, 'https://') === 0) 
                                                        ? $evidencia 
                                                        : Storage::disk('public')->url($evidencia);
                                                @endphp
